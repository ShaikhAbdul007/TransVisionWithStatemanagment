...
import 'package:tranvision_customer_app/controller/consigneController/detention_controller.dart';
...
class DetentionInvoice extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    DetentionController detentionController = Get.put(DetentionController());
    return Scaffold(
      appBar: AppBar(
        title: WeightText(
            color: AppColor.black, text: 'Detention Invoice', size: 20.sp),
        centerTitle: true,
        elevation: 1.0,
      ),
      body: ListView(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          controller: detentionController.detentionFromDate,
                          decoration: InputDecoration(
                              ...
                              suffixIcon: IconButton(
                                onPressed: () {
                                  detentionController.chooseFromDate();
                                },
                        ...
                        SizeBox.customHeight(8.h),
                        TextField(
                          controller: detentionController.detentioneToDate,
                          decoration: InputDecoration(
                              hintText: "Select the date",
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(20.r),
                              ...
                              suffixIcon: IconButton(
                                onPressed: () {
                                  detentionController.chooseToDate();
                                },
                                icon: const Icon(Icons.calendar_month_outlined),
                              )),
                        ),
                        ...
                        SizeBox.customHeight(8.h),
                        TextFormField(
                          controller: detentionController.detentionReference,
