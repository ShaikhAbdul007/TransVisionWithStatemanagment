...
class BillSummaryRefreshWithDate {
  BillSummaryRefreshWithDate({
    int? balamt,
    String? billdate,
    int? billno,
    num? billtotals,
  ...
  BillSummaryRefreshWithDate.fromJson(dynamic json) {
    _balamt = json['balamt'];
  ...
  String? _vesselname;
  String? _voyage;
  BillSummaryRefreshWithDate copyWith({
    int? balamt,
    String? billdate,
    int? billno,
    double? billtotals,
